							...
							<li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true" m-menu-submenu-toggle="hover"><a href="javascript:;" class="m-menu__link m-menu__toggle"><i class="m-menu__link-icon flaticon-layers"></i><span class="m-menu__link-text">{{$t('base')}}</span><i
								...
								<div class="m-menu__submenu "><span class="m-menu__arrow"></span>
									<ul class="m-menu__subnav">
										...
										<li class="m-menu__item " aria-haspopup="true"><router-link class="m-menu__link " to="/picker"><i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span class="m-menu__link-text">Picker</span></router-link></li>
										<li class="m-menu__item " aria-haspopup="true"><router-link class="m-menu__link " to="/calendar"><i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span class="m-menu__link-text">Calendar</span></router-link></li>
										<li class="m-menu__item " aria-haspopup="true"><router-link class="m-menu__link " to="/managePreferences"><i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span class="m-menu__link-text">Manage preferences</span></router-link></li>
										<li class="m-menu__item " aria-haspopup="true"><router-link class="m-menu__link " to="/items"><i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span class="m-menu__link-text">Items</span></router-link></li>
										<li class="m-menu__item " aria-haspopup="true"><router-link class="m-menu__link " to="/tabs"><i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span class="m-menu__link-text">Tabs info</span></router-link></li>
										<li class="m-menu__item " aria-haspopup="true"><router-link class="m-menu__link " to="/regform"><i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span class="m-menu__link-text">Registar Form</span></router-link></li>
										<li class="m-menu__item " aria-haspopup="true"><router-link class="m-menu__link " to="/chat"><i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span class="m-menu__link-text">Chat</span></router-link></li>
